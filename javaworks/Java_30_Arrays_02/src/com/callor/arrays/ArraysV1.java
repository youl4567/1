...
/* eClipse 에서 한 줄을 삭제할 때 Crtl + d*/
	...
	public static void main(String[] args) {
		...
		intNums[3] = 40;
		intNums[4] = 50;
		// intNums[5] 부터 intNums[8] 까지는 0으로 clear 된 상태
		intNums[9] = 100;
		...
		/* print() method 는 () 안의 데이터 type 에 따라 작동하는 방식이 다르다. 
		 ...
		 * 
		 * print( 배열 ) : 배열.toString() 를 먼저 실행하고 return 된 기억장소 주소를 console 에 출력
		 * */
