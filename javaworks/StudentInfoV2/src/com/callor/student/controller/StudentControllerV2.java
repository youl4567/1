...
public class StudentControllerV2 {
	 ...
	 * 
	 * 하지만 V2 에서는 ControllerV2 에서 Service2 를 사용할 때
	 * stdList 와 fileName 을 생성자 매개변수로 전달하고 있다.
	 * 이러한 패턴은 Controller 와 Service 간에 결합도록 낮추어
	 * 더 좋은 패턴의 코드가 된다.
	 * 
	 */
	public static void main(String[] args) throws FileNotFoundException {
		...
		// 자바 1.5 이상에서 텍스트 파일에 내용을 기록하기 위하여
		// 단독으로 사용할 수 있는 클래스
		...
		// stdent.txt 파일에서 데이터를 읽어 stdList 를 준비하라
