...
public class Var_03 {
	...
	public static void main(String[] args) {
		 ...
		 * boolean의 값이 true 인가 false 인가에 따라서
		 * 명령문을 선택적으로 실행할 수 있다.
		 */
		if(bEven) { System.out.println(intNum1 + " 는 짝수"); }
		...
		if( (intNum1 % 4) == 0) { System.out.println(intNum1 + " 는 4의 배수"); }
		else if( (intNum1 % 3) == 0) { System.out.println(intNum1 + " 는 4의 배수가 아니다");
										System.out.println("하지만 3의 배수이다");		}
		else if((intNum1 %2) == 0) { System.out.println(intNum1 + " 는 4의 배수가 아니다");
