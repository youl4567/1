...
public class Var_01 {
	 ...
	 * 		Java 시작점, 진입점 method 명렁 그룹 이라고 한다.
	 * 
	...
	public static void main(String[] args) {
		 ...
		 * 하나의 명령무냐(statement)를 구현(명령문을 문법에 맞게 완성)한다.
		 * 
		...
		// method 에 따라 args 가 있거나 없거나 상관없이 작동 되기도 하고
		//			없으면 문법 오류가 발생하기도 한다.
		// method 에 첨가되는 args 는 method 코드가 만들어질때
		// 			정해지는 것으로 특별한 규칙이 없다.
		//			사용하는 사람이 잘~~ 잘차서 사용해야 한다.
		System.out.print(0);
