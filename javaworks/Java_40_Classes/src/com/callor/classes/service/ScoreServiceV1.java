...
public class ScoreServiceV1 {
	...
	/*
	 * 상속을 염두에 두고 클래스를 선언할때는 인스턴스변수들을 private 이 아닌 protected 로 선언한다. protected는
	 * private 의 성질을 가지면서 상속받은 클래스에서 상속받아 변수를 선언한 것과 같은 효과를 낸다. 인스턴스변수도 상속이 된다.
	 */
