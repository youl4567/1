...
public class Operator_01 {
	...
	public static void main(String[] args) {
		...
		// 대입연산자
		intNum2 = ++intNum1; // intNum1 을 1 증가시키고 결과를 intNum2 에 저장
		System.out.println(intNum2);
		
		// 대입연산자
		intNum1 = intNum1 + 10; // intNum1 의 값을 10 증가시켜라
		intNum2 = intNum1; // intNum1 에 저장된 값을 intNum2 에 복사하라
		System.out.println(intNum2);
		
		// 복합연산자(+=, *=, -=, /=)
		// 먼저 앞의 변수 이름이 설정된 기억장치에서 값을 읽어 온 후
		// 연산(여기서는 +10)을 실행하고
		// 결과를 맨 앞의 변수에 저장하라
