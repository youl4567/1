...
const student = { 이름: "홍길동", 나이: "33", 전화: "010-11-11" };
...
/*
논리적 false 인 변수와 OR(||) 연산자를 조합하면 상당히 편리한 코드 구성이 가능하다.
논리적 false 변수가 있으면 건너뛰기를 실행하여 오른쪽의 값을 변수에 할당한다.
 */
let btitile =
  title || title2 || title3 || title4 || title5 || title6 || "우리나라";
